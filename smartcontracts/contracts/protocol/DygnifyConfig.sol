...
contract DygnifyConfig is BaseUpgradeablePausable{
    ...
    function setAddress(uint256 addressIndex, address newAddress)public nonReentrant onlyAdmin{
    ...
    function setNumber(uint256 id, uint256 newNumber)public nonReentrant onlyAdmin{
