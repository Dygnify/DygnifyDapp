...
describe("One opportunity Seven investors", function () {
  let dygnifyConfig,
    seniorPool,
    lpToken,
    borrowerContract,
  ...
  const oneOpportunitySevenInvestor = ({
    opportunityName,
    opportunityInfo,
    loanType,
    loanAmount,
    ...
    async function () {
      ...
      await seniorPool.connect(investorUser).stake(seniorAmount.div(6));
      await seniorPool.connect(investorUser2).stake(seniorAmount.div(9).mul(2));
      await seniorPool.connect(investorUser3).stake(seniorAmount.div(3));
      await seniorPool.connect(investorUser4).stake(seniorAmount.div(12));
      await seniorPool.connect(investorUser5).stake(seniorAmount.div(18));
      await seniorPool.connect(investorUser6).stake(seniorAmount.div(36));
      await seniorPool.connect(investorUser7).stake(seniorAmount.div(36).mul(5));
