...
describe("One opportunity Six investors", function () {
  let dygnifyConfig,
    seniorPool,
    lpToken,
    borrowerContract,
  ...
  const oneOpportunitySixInvestor = ({
    opportunityName,
    opportunityInfo,
    loanType,
    loanAmount,
    ...
    async function () {
      ...
      await seniorPool.connect(investorUser).stake(seniorAmount.div(10));
      await seniorPool.connect(investorUser2).stake(seniorAmount.div(5));
      await seniorPool.connect(investorUser3).stake(seniorAmount.div(20).mul(3));
      await seniorPool.connect(investorUser4).stake(seniorAmount.div(8));
      await seniorPool.connect(investorUser5).stake(seniorAmount.div(4));
      await seniorPool.connect(investorUser6).stake(seniorAmount.div(40).mul(7));
