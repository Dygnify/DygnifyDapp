...
describe("One opportunity four investors", function () {
	let dygnifyConfig,
		seniorPool,
		lpToken,
		borrowerContract,
	...
	// Four different investors invested in 1 opportunity
	const oneOpportunityFourInvestor = ({
		opportunityName,
		opportunityInfo,
		loanType,
		loanAmount,
