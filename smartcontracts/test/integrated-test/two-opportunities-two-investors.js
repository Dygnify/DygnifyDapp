...
describe("Two opportunities two investors", function () {
	let dygnifyConfig,
		seniorPool,
		lpToken,
		borrowerContract,
	...
	// Two investors invested in both opportunity
	const twoOpportunityTwoInvestor = ({
		opportunityName,
		opportunityInfo,
		loanType,
		loanAmount,
		...
		async function () {
			...
			expect(afterBalance.sub(beforeBalance)).to.equal(expectedUSDCAmount * 2);
