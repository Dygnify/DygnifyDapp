...
describe("One opportunity eight investors", function () {
  let dygnifyConfig,
    seniorPool,
    lpToken,
    borrowerContract,
  ...
  const oneOpportunityEightInvestor = ({
    opportunityName,
    opportunityInfo,
    loanType,
    loanAmount,
    ...
    async function () {
      ...
      await seniorPool.connect(investorUser).stake(seniorAmount.div(8));
      await seniorPool.connect(investorUser2).stake(seniorAmount.div(16).mul(2));
      await seniorPool.connect(investorUser3).stake(seniorAmount.div(4));
      await seniorPool.connect(investorUser4).stake(seniorAmount.div(24).mul(3));
      await seniorPool.connect(investorUser5).stake(seniorAmount.div(6));
      await seniorPool.connect(investorUser6).stake(seniorAmount.div(12));
      await seniorPool.connect(investorUser7).stake(seniorAmount.div(3));
      await seniorPool.connect(investorUser8).stake(seniorAmount.div(24).mul(3));
