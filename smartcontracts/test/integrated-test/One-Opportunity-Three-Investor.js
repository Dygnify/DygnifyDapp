...
describe("One opportunity Three investors", function () {
  let dygnifyConfig,
    seniorPool,
    lpToken,
    borrowerContract,
  ...
  const oneOpportunityThreeInvestor = ({
    opportunityName,
    opportunityInfo,
    loanType,
    loanAmount,
    ...
    async function () {
      ...
      await seniorPool.connect(investorUser).stake(seniorAmount.div(2));
      await seniorPool.connect(investorUser2).stake(seniorAmount.div(4));
