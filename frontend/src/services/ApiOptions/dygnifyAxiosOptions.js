...
function dygnifyBusinessOwnerUpdationOption(
	ownerDetails,
	bearerToken,
	businessOwnerId
) {
...
function dygnifyUpdateOwnerKycOption(
	ownerkycDetails,
	bearerToken,
	businessOwnerId
) {
	...
	var api_options = {
		method: "put",
		url:
			process.env.REACT_APP_DYGNIFY_URL + "businessownerkyc/" + businessOwnerId,
		headers: {
			Authorization: bearerToken,
			"Content-Type": "application/json",
		},
...
function dygnifyUpdateBusinessOptions(
...
function dygnifyUpdateCoBorrowerOptions(
	createCoBorrowerDetails,
	bearerToken,
	co_borrowerId
) {
	var data = JSON.stringify(createCoBorrowerDetails);
...
function dygnifyUpdateCoborrowerKycOption(
	ownerkycDetails,
	bearerToken,
	co_borrowerId
) {
	...
	var api_options = {
		method: "put",
		url:
			process.env.REACT_APP_DYGNIFY_URL + "businessownerkyc/" + co_borrowerId,
		headers: {
			Authorization: bearerToken,
			"Content-Type": "application/json",
		},
...
function dygnifyUpdatekarzaAPIDumpOption(
	karzaAPIDump,
	bearerToken,
	karzaAPIDumpId
) {
