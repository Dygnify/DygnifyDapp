        ...
        <div >
            ...
            <div style={{ backdropFilter: 'brightness(40%) blur(8px)' }} className="modal">
                <div style={{ backgroundColor: '#20232A', borderRadius: '16px' }} className="modal-box w-1/3 max-w-5xl p-0">
                    <label for="drawdown-modal" class="btn btn-ghost absolute right-2 top-2 pb-2">✕</label>
                    ...
                    <div style={{ backgroundColor: '#292C33', borderRadius: '4px' }} className='mx-4 mb-3 py-4 px-4'>
