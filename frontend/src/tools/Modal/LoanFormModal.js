...
const LoanFormModal = ({ handleForm }) => {
    ...
    const displayStep = (step) => {
        switch (step) {
            ...
            case 2:
                return <Details handleNext={handleNext} handlePrev={handlePrev} formData={formData} />;
            case 3:
                return <Final handlePrev={handlePrev} finalSubmit={finalSubmit} formData={formData} />;
            default:
        }
    };
