        ...
        <div style={{ display: 'flex' }} className="flex-col ">
            <form onSubmit={formik.handleSubmit}>
                <div style={{ display: 'flex' }}>
                    <TextField name='loan_name' onChange={formik.handleChange}
                        onBlur={formik.handleBlur} className='w-1/2 mr-2' label='Pool Name' placeholder='Enter Pool Name' error={
                    ...
                    <TextField name='loan_amount'
                        ...
                        className='w-1/2 ml-2' label='Loan Amount' placeholder='Enter Loan Name'></TextField>
                </div>
                <div style={{ display: 'flex' }}>
                    <TextField name='loan_tenure'
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        error={
                        ...
                        className='w-1/2 mr-2' label='Loan Tenure' placeholder='Enter Loan Tenure'></TextField>
                    <TextField name='payment_frequency'
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        error={
                        ...
                        className='w-1/2 ml-2' label='Repayment Frequency' placeholder='Enter Repayment Frequency'></TextField>
                </div>
                <div style={{ display: 'flex' }}>
                    <TextField name='loan_interest'
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        error={
