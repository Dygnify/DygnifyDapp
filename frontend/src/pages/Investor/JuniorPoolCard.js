...
const JuniorPoolCard = ({ data }) => {
    const { id, opportunity_name, opportunity_owner, invest_amount, loan_interest, available_withdrawal } = data;
    return (
        <>
            <Box>
                <Card
                ...
                >
                    ...
                    <div>
                        <Typography variant="subtitle2">{invest_amount} {process.env.REACT_APP_TOKEN_NAME}</Typography>
                    ...
                    <Divider orientation="vertical" variant="middle" flexItem />{" "}
                    <div>
                        <Typography variant="subtitle2">{available_withdrawal} {process.env.REACT_APP_TOKEN_NAME}</Typography>
