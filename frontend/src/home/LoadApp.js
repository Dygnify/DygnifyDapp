			...
			>
				<Typography
					style={{
						...
						fontWeight: "400",
						fontFamily:
							"IBM Plex Mono, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New",
					}}
				>
					The new decentralized credit marketplace connecting investors with
